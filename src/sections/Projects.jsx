...
const projects = [
  {
    ...
    githubLink:
      "https://github.com/vishakha143/shopPilot-frontend",
  },

  {
    ...
    liveLink:
      "https://visera-git-main-vishakha143s-projects.vercel.app/",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            Projects where I've applied full-stack development,
            problem solving, databases, APIs, and AI-powered
            features to build practical applications.
          </p>
        </div>
