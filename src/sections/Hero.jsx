import { ArrowDownRight, ArrowUpRight, Code2, Database, Sparkles } from "lucide-react";
...
export const Hero = () => (
  <section id="home" className="relative isolate min-h-screen overflow-hidden">
    ...
    <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_74%_32%,rgba(32,178,166,0.18),transparent_30%),linear-gradient(180deg,var(--color-surface-1)_0%,var(--color-background)_68%,var(--color-background)_100%)]"/>
      ...
      <div className="grid min-h-[calc(100vh-10rem)] items-center gap-14 lg:grid-cols-[1.08fr_0.92fr]">
        <div className="max-w-3xl">
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4 animate-fade-in animation-delay-300">
            <a href="#projects" onMouseEnter={() => setCompanionMode("build")} onMouseLeave={() => setCompanionMode("idle")} onFocus={() => setCompanionMode("build")} onBlur={() => setCompanionMode("idle")} className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition hover:-translate-y-0.5">
        ...
        <div className="relative mx-auto w-full max-w-xl">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-border bg-card/90 p-5 shadow-2xl">
